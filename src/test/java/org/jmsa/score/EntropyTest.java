...
/**
 * implement Test for Entropy Entropy of one different word is 0; p.e: entropy(['A']['A'])=0 Entropy
 * of two different words is 0.69 Entropy of four different words is 1.39 Entropy of a sequence with
 * gaps doesn't change the result
 */
public class EntropyTest {
  ...
  public void shouldEntropyOfSequenceOf2DifferentNucleotidesReturn069() {
    ...
    double obtainedValueRoundedWithTwoDecimals =
        (double) Math.round(entropy.compute(sequence) * 100d) / 100d;
