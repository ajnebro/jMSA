...
public class Example2 {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Entropy: " + entropy.compute(seq) + "\n"
            + "Percentage of non gaps: " + pong.compute(seq) + "% \n"
            + "Percentage of totally conserved columns: " + potcc.compute(seq) + "% \n"
            + "Star PAM250: " + star1.compute(seq) + "\n"
            + "Star Blosum62: " + star2.compute(seq) + "\n"
            + "Sum of pairs PAM250: " + sop1.compute(seq) + "\n"
            + "Sum of pairs Blosum62: " + sop2.compute(seq) + "\n");
