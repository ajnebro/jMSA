...
public class Example6 {
  public static void main(String[] args) throws FileNotFoundException {
    try {
      ...
      char[][] CoVsequence =
          readMSA.readSequenceFromFastaFile("./resources/data/secuenciaalineada.fasta");
      ...
      System.out.println(
          "Percentage of totally conserved columns: "
              + percentageOfTotallyConservedColumns.compute(CoVsequence));
      System.out.println("Entropy score: " + entropy.compute(CoVsequence));
      System.out.println(
          "Sum of Pairs score (Blosum62): " + sumOfPairsBlosum62.compute(CoVsequence));
